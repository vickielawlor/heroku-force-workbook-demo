...
class MyApp < Sinatra::Base
  ...
  get '/' do
    ...
    @accounts2 = clientt.query("SELECT FirstName,LastName FROM USER LEFT JOIN EVENT ON user.Id = event.OwnerId WHERE StartDateTime  >=  #{d}T07:30:00.000+0000 AND EndDateTime <= #{d}T17:30:00.000+0000")

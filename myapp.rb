...
class MyApp < Sinatra::Base
  ...
  get '/' do
    ...
    @accounts2 = clienttt.query("SELECT owner.name from event where StartDateTime>#{d}T07:29:00.000Z and EndDateTime<#{d}T17:01:00.000Z and owner.title in ('cloud services engineer','cloud service engineer') and showas= 'busy'")
    @accounts3 = clientt.query("SELECT owner.name from event where StartDateTime>#{d}T07:29:00.000Z and EndDateTime<#{d}T17:01:00.000Z and owner.title in ('cloud services engineer','cloud service engineer') and showas= 'busy'")
    erb :index
  end

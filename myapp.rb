...
class MyApp < Sinatra::Base
  ...
  get '/' do
   ...
   @accounts2 = clienttt.query("SELECT Owner.Name FROM EVENT WHERE StartDateTime>2015-07-07T07:29:00.000Z AND EndDateTime<2015-09-07T16:31:00.000Z and (Owner.title ='cloud services engineer' or owner.title = 'cloud service engineer') Group By Owner.name")
    erb :index
  end

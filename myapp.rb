...
class MyApp < Sinatra::Base
  ...
  get '/' do
   ...
   @accounts3 = clientt.query("SELECT Owner.Name FROM EVENT WHERE ShowAs = 'busy' and StartDateTime>2015-07-07T07:29:00.000Z AND EndDateTime<2015-07-07T17:31:00.000Z and Owner.UserRole = 'GSS-Bangalore Engineer' ")
  end

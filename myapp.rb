...
class MyApp < Sinatra::Base
  ...
  get '/' do
    ...
    @accounts2 = clienttt.query("SELECT owner.name from event where StartDateTime>2015-07-08T07:29:00.000Z and EndDateTime<2015-07-08T17:01:00.000Z and owner.title in ('cloud services engineer','cloud service engineer') and showas= 'busy'")
    erb :index
  end
